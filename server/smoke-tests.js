...
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "main.jsx"), "utf8").includes("completionAudit?.nextStep"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "main.jsx"), "utf8").includes("ProductVisualAuthorizationPreview"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes("product-v1-product-visual-authorization-preview"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowV1AcceptanceReport.js"), "utf8").includes("/api/v1-acceptance/product-visual-sample/approval/preflight"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowV1AcceptanceReport.js"), "utf8").includes("/api/v1-acceptance/product-visual-sample/approval/approve"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowV1AcceptanceReport.js"), "utf8").includes("确认样张关卡"));
assert.ok(apiClientSource.includes("preflightProductVisualSample"));
assert.ok(apiClientSource.includes("previewProductVisualSamplePrompt"));
assert.ok(apiClientSource.includes("preflightProductVisualSampleApproval"));
assert.ok(apiClientSource.includes("approveProductVisualSample"));
assert.ok(apiClientSource.includes("preflightProductVisualFullDeck"));
assert.ok(apiClientSource.includes("runProductVisualSample"));
assert.ok(apiClientSource.includes("runProductVisualFullDeck"));
assert.ok(apiClientSource.includes("error.data = data"));
assert.ok(apiClientSource.includes("error.status = response.status"));
assert.ok(apiClientSource.includes("error.code = data.code"));
assert.ok(frontendSource.includes("检查真实样张条件"));
assert.ok(frontendSource.includes("生成真实样张"));
assert.ok(frontendSource.includes("我确认使用 1 次外部图片 API"));
assert.ok(frontendSource.includes("product-v1-product-visual-run-result"));
assert.ok(frontendSource.includes("ProductVisualQualityReport"));
assert.ok(frontendSource.includes("product-v1-product-visual-quality"));
assert.ok(frontendSource.includes("productVisualSpendPlan"));
assert.ok(frontendSource.includes("product-v1-product-visual-spend-plan"));
assert.ok(frontendSource.includes("外部图片 API 计划"));
assert.ok(frontendSource.includes("product-v1-completion-audit"));
assert.ok(frontendSource.includes("完整性结论"));
assert.ok(frontendSource.includes("尚未完整"));
assert.ok(frontendSource.includes("工具不会自动花费"));
assert.ok(frontendSource.includes("ProductVisualExecutionSnapshot"));
assert.ok(frontendSource.includes("ProductVisualPromptPreview"));
assert.ok(frontendSource.includes("productVisualSamplePromptPreview"));
assert.ok(frontendSource.includes("artifactLink"));
assert.ok(frontendSource.includes("打开 Prompt 证据"));
assert.ok(frontendSource.includes("expectedJobId={productVisualSamplePreflight.jobId}"));
assert.ok(frontendSource.includes("promptPreviewMatchesSamplePreflight"));
assert.ok(frontendSource.includes("Prompt 证据"));
assert.ok(frontendSource.includes("预检一致"));
assert.ok(frontendSource.includes("需重新预览"));
assert.ok(frontendSource.includes("请先预览当前预检任务的样张 prompt"));
assert.ok(frontendSource.includes("previewProductVisualSamplePrompt"));
assert.ok(frontendSource.includes("ProductVisualSampleReviewChecklist"));
assert.ok(frontendSource.includes("sampleReviewChecklist"));
assert.ok(frontendSource.includes("打开源页对照"));
assert.ok(frontendSource.includes("product-v1-product-visual-review-actions"));
assert.ok(frontendSource.includes("ProductV1PhaseProgress"));
assert.ok(frontendSource.includes("整体阶段进度"));
assert.ok(frontendSource.includes("product-v1-phase-progress"));
assert.ok(frontendSource.includes("ProductVisualNextStagePlan"));
assert.ok(frontendSource.includes("nextStagePlan"));
assert.ok(frontendSource.includes("下一阶段计划"));
assert.ok(frontendSource.includes("product-v1-product-visual-next-stage-plan"));
assert.ok(frontendSource.includes("buildProductVisualAgentNextAction"));
assert.ok(frontendSource.includes("Agent 推荐下一步"));
assert.ok(frontendSource.includes("product-v1-agent-next-action"));
assert.ok(frontendSource.includes("productVisualFullDeckMode"));
assert.ok(frontendSource.includes("productVisualFullDeckTargetPages"));
assert.ok(frontendSource.includes("productVisualFullDeckPages"));
assert.ok(frontendSource.includes("fullDeckSelectedPagesLabel"));
assert.ok(frontendSource.includes("生成页码"));
assert.ok(frontendSource.includes("countPageSelection"));
assert.ok(frontendSource.includes("parsePageSelectionInput"));
assert.ok(frontendSource.includes("customPagesReady"));
assert.ok(frontendSource.includes("没有解析到有效页码"));
assert.ok(frontendSource.includes("onProductVisualFullDeckPagesChange"));
assert.ok(frontendSource.includes("指定页"));
assert.ok(frontendSource.includes("页码范围"));
assert.ok(frontendSource.includes("productVisualFullDeckRequestBody"));
assert.ok(frontendSource.includes("product-v1-product-visual-target-mode"));
assert.ok(frontendSource.includes("2 页测试"));
assert.ok(frontendSource.includes("maxPages: productVisualFullDeckTargetPages"));
assert.ok(frontendSource.includes("sampleExecutionSnapshot"));
assert.ok(frontendSource.includes("fullDeckExecutionSnapshot"));
assert.ok(frontendSource.includes("product-v1-product-visual-execution-snapshot"));
assert.ok(frontendSource.includes("product-v1-product-visual-sample-approval"));
assert.ok(frontendSource.includes("检查样张确认"));
assert.ok(frontendSource.includes("确认样张关卡"));
assert.ok(frontendSource.includes("preflightProductVisualFullDeckApproval"));
assert.ok(frontendSource.includes("approveProductVisualFullDeck"));
assert.ok(frontendSource.includes("检查全量确认"));
assert.ok(frontendSource.includes("确认全量关卡"));
assert.ok(frontendSource.includes("onPreflightProductVisualFullDeckApproval={onPreflightProductVisualFullDeckApproval}"));
assert.ok(frontendSource.includes("onApproveProductVisualFullDeck={onApproveProductVisualFullDeck}"));
assert.ok(frontendSource.includes("productVisualFullDeckApprovalPreflight={productVisualFullDeckApprovalPreflight}"));
assert.ok(frontendSource.includes("productVisualSampleApprovalPreflight.sampleLink?.href"));
assert.ok(frontendSource.includes("productVisualFullDeckApprovalPreflight.sampleLink?.href"));
assert.ok(frontendSource.includes("setProductVisualSamplePreflight(error.data.preflight)"));
assert.ok(frontendSource.includes("setProductVisualSampleApprovalPreflight(error.data.preflight)"));
assert.ok(frontendSource.includes("setProductVisualFullDeckApprovalPreflight(error.data.preflight)"));
assert.ok(frontendSource.includes("setProductVisualFullDeckPreflight(error.data.preflight)"));
assert.ok(frontendSource.includes("product-v1-product-visual-stale"));
assert.ok(frontendSource.includes("产品视觉预检已过期"));
assert.ok(frontendSource.includes("打开样张"));
assert.ok(!frontendSource.includes("下载图片型 PPT"));
assert.ok(frontendSource.includes("最终只交付可编辑 PPT"));
assert.ok(frontendSource.includes("查看图片型 PPT 中间产物"));
assert.ok(frontendSource.includes("latestProductVisualNext"));
assert.ok(frontendSource.includes("productVisualTargetPages"));
assert.ok(frontendSource.includes("maxPages: productVisualTargetPages"));
assert.ok(frontendSource.includes("confirmLatestProductVisualFullDeck"));
assert.ok(frontendSource.includes("product-v1-product-visual-actions-contract"));
assert.ok(frontendSource.includes("paidImageGeneration"));
assert.ok(frontendSource.includes("生成${fullDeckTargetLabel}图片型 PPT"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowProductVisualReadinessRunner.js"), "utf8").includes("pages: options.pages"));
assert.ok(productVisualReadinessRunnerSource.includes("parsePageSelection"));
assert.ok(productVisualReadinessRunnerSource.includes("selectedPages"));
assert.ok(productVisualReadinessRunnerSource.includes("指定页码无效或超出范围"));
assert.ok(productVisualReadinessRunnerSource.includes("invalidateWorkflowEditableRebuildEvidence"));
assert.ok(productVisualReadinessRunnerSource.includes("旧可编辑重建证据已失效"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowDelivery.js"), "utf8").includes("inspectVisualEditableFreshness"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowV1AcceptanceReport.js"), "utf8").includes("inspectEditableVisualFreshness"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowV1AcceptanceReport.js"), "utf8").includes("productVisualDeckReady"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowV1AcceptanceReport.js"), "utf8").includes('acceptanceCheckPassed(acceptance, "image-deck")'));
assert.ok(frontendSource.includes("我确认使用"));
assert.ok(frontendSource.includes("product-v1-product-visual-sample-preflight"));
assert.ok(frontendSource.includes("检查 ${fullDeckTargetLabel} 条件"));
assert.ok(frontendSource.includes("{fullDeckTargetLabel}生成预检"));
assert.ok(frontendSource.includes("${fullDeckTargetLabel} 条件未满足"));
...
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowWorkerBatchRunner.js"), "utf8").includes("rapidOcrTextHintsAccepted"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "server", "workflowEditable.js"), "utf8").includes("getRapidOcrTextHintsCheckpoint"));
...
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-sample-confirm"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-sample-approval"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-stale"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-actions-contract"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-spend-plan"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-execution-snapshot"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-prompt-preview"));
assert.ok(fs.readFileSync(path.join(process.cwd(), "src", "styles.css"), "utf8").includes(".product-v1-product-visual-review-checklist"));
...
assert.ok(frontendSource.includes("PPT 智能体主流程"));
