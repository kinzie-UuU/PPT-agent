...
assert.ok(frontendSource.includes("产品图变了只重做资产复用/裁切"));
assert.ok(frontendSource.includes("findSampleAssetPage"));
assert.ok(frontendSource.includes("const canApprove = Boolean(pageRecord"));
...
assert.ok(frontendSource.includes("复核整套图片"));
